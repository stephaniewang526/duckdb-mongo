...
inline void check_query_result(const std::unique_ptr<duckdb::QueryResult> &result, const std::string &query = "") {
	if (result->HasError()) {
...
#define REQUIRE_NO_FAIL(result) check_query_result(result)
